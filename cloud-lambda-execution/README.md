...
This is a sample template for lambda-application - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name lambda-application --tail
```
...
```bash
aws cloudformation delete-stack --stack-name lambda-application
```
